...
async function main() {
  ...
  try {
    ...
    await page.locator(".review-panel summary").click(); await page.getByPlaceholder("Optional review summary").fill("Harden the reminder API before shipping."); await page.getByRole("button", { name: "Return Feedback" }).click(); await wait(700);
